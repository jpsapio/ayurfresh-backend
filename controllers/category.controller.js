...
class CategoryController {
  static async create(req, res) {
    try {
      ...
      if (existing) return errorResponse(res, 400, 'Category name or slug already exists')
  ...
  static async update(req, res) {
    try {
      ...
      if (existing) return errorResponse(res, 400, 'Category name or slug already in use')
      ...
      return errorResponse(res, 400, 'Validation failed', error.messages || undefined)
    }
  }
